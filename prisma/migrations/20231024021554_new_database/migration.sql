...
-- CreateTable
CREATE TABLE "UserPreferenece" (
    "id" TEXT NOT NULL,
    "emailUpdates" BOOLEAN NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "UserPreferenece_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserPreferenece_userId_key" ON "UserPreferenece"("userId");
...
-- AddForeignKey
ALTER TABLE "UserPreferenece" ADD CONSTRAINT "UserPreferenece_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
